...
function RevitAddins() {
  return (
    <div className="flex-col pt-16">
      ...
      <ProjectPresentation
        projLink="github.com/haudacia/pyrevit-addins"
...
"
        problemSolving={
          "large amount of Revit models with high levels of detail, that need to be consistent and fit the evolving standards established by the team"
        }
        feats={[
          "reliable model reviews, some including automatic fixes, allows user input",
        ]}
